...
Button(root,text="/", width=5,height=1, font=("arial",30,"bold"),bd=1,fg="black", bg="gray",  command=lambda: show("/")).place(x=150,y=100)
Button(root,text="%", width=5,height=1, font=("arial",30,"bold"),bd=1,fg="black", bg="gray",command=lambda: show("%")).place(x=290,y=100)
Button(root,text="*", width=5,height=1, font=("arial",30,"bold"),bd=1,fg="black", bg="gray",command=lambda: show("*")).place(x=430,y=100)
...
Button(root,text="-", width=5,height=1, font=("arial",30,"bold"),bd=1,fg="black", bg="gray",command=lambda: show("-")).place(x=430,y=200)
...
Button(root,text="+", width=5,height=1, font=("arial",30,"bold"),bd=1,fg="black", bg="gray",command=lambda: show("+")).place(x=430,y=300)
...
Button(root,text="0", width=11,height=1, font=("arial",30,"bold"),bd=1,fg="black", bg="gray",command=lambda: show("0")).place(x=10,y=500)

Button(root,text=".", width=5,height=1, font=("arial",30,"bold"),bd=1,fg="black", bg="gray",command=lambda:   show(".")).place(x=290,y=500)

Button(root,text="=", width=5,height=3, font=("arial",30,"bold"),bd=1,fg="black", bg="red",command=lambda: calculate()).place(x=430,y=400)
